...
import randomJava.MiddleSquare;

public class MidSquareChartP extends ApplicationFrame{
	
	public MidSquareChartP(final String title) {
	 ...
	 private XYDataset createDataset() {
		 ...
		 MiddleSquare random = new MiddleSquare(noOfNumbersToBeGenerated);
		 List<Integer> numbers = random.poissonGenerator(l);
