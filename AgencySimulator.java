...
class AgencySimulator
{
    ...
    {
        AgencySimulator runAgencySimulator=new AgencySimulator();
        runAgencySimulator.setupParameters();
        runAgencySimulator.doSimulation();
        runAgencySimulator.printStatistics();
    }
